...
int main()
{
	...
	Shader simpleDepthShader("shaders/point_shadows_depth.vs", "shaders/point_shadows_depth.frag", "shaders/point_shadows_depth.gs");
	...
	// Load textures
	woodTexture = loadTexture("Textures/woodplane.jpg");
