...
int main()
{
	...
	Shader shader("shaders/skyboxAdvanced.vs", "shaders/skyboxAdvanced.frag");
	...
	faces.push_back("Cubemaps/arne_nebula/purplenebula_rt.jpg");
	faces.push_back("Cubemaps/arne_nebula/purplenebula_lf.jpg");
	faces.push_back("Cubemaps/arne_nebula/purplenebula_up.jpg");
	faces.push_back("Cubemaps/arne_nebula/purplenebula_dn.jpg");
	faces.push_back("Cubemaps/arne_nebula/purplenebula_bk.jpg");
	faces.push_back("Cubemaps/arne_nebula/purplenebula_ft.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelPlanet = glm::translate(modelPlanet, glm::vec3(0.0f, -5.0f, 0.0f));
		modelPlanet = glm::scale(modelPlanet, glm::vec3(4.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(glGetUniformLocation(planetShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelPlanet));
